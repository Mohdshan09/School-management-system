    ...
    return (
        <div className="p-4 flex items-center justify-between text-gray-500">
            ...
            <div className="flex items-center gap-2 text-sm">
                <button className="px-2 ronded-sm bg-blue-400">1</button>
                <button className="px-2 ronded-sm">2</button>
                <button className="px-2 ronded-sm">3</button>
                <button className="px-2 ronded-sm">4</button>
            </div>
