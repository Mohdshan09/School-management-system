...
import { classesData, eventsData, lessonsData, role, studentsData, subjectsData } from "@/lib/data";
...
const page = () => {
    ...
    const renderRow = (item: Events) => (
        <tr className="border-b border-gray-200 even:bg-slate-50 text-sm hover:bg-lamaPurpleLigh" key={item.id}>
            ...
            <td>
                <div className="flex items-center gap-2">
                    ...
                    {
                        role === "admin" && <button className="w-7 h-7 flex items-center justify-center rounded-full bg-blue-400">
